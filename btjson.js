            ...
            e.exports = function(e) {
                ...
                return t += '<div id="loading-box"><div class="loading"><p class="pic"></p><div class="tips"></div></div><div type="button" id="close" ><span id="link1">播放器已连接</span><span id="link2">弹幕正在连接中</span><span id="link2-success">弹幕已填装完毕</span><span id="link2-error">弹幕连接失败</span><span id="link3"><e id="link3_tip">等待视频连接中</e><!--d class="wait"><e id="span">3</e>s</d--></span></div></div><div class="btjson-mask"></div>\n<div class="btjson-cplayer"><div class="btjson-showing"><svg aria-hidden="true"><use xlink:href="#icon-play"></use></svg></div></div><div class="btjson-video-wrap">\n    ',
                    function(e) {
                        ...
                        t += '\n        <div class="btjson-menu-item">\n            <a  href="', t += s(e.link || "javascript:void(0);"), t += '">', t += s(r(e.text)), t += "</a>\n        </div>\n    "
                ...
                o = function() {
                    ...
                    return a(e, [{
                        ...
                        value: function() {
                            ...
                            this.template.infoVersion.innerHTML = "2.0.1", this.template.infoType.innerHTML = this.player.type, this.template.infoUrl.innerHTML = "https://baidu.com/", this.template.infoResolution.innerHTML = this.player.video.videoWidth + " x " + this.player.video.videoHeight, this.template.infoDuration.innerHTML = formatTime(this.player.video.duration), this.player.options.danmaku && (this.template.infoDanmakuId.innerHTML = this.player.options.danmaku.id, this.template.infoDanmakuApi.innerHTML = this.player.options.danmaku.api, this.template.infoDanmakuAmount.innerHTML = this.player.danmaku.dan.length - 2)
                        }
                    }, {
                        key: "fps",
                        value: function(e) {
